...
6. **極限まで逸脱せよ**: あなたの観点を可能な限り極限まで推し進め、他の観点と相容れないほど先鋭化した主張を形にせよ。この不整合は意図的である——後の昇華（アウフヘーベン）で一段高い次元へ引き上げるための素材となる。妥協や中間解を出してはならない。
7. **枠を埋める**: 草案の末尾に必ず以下のセクションを付ける。昇華段階があなたの最強の主張を確実に拾うための定型。本編の自由な論述に加えて、ここでは断言に絞る。
