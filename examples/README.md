...
- `input.md` — 元のタスク
- `draft_{agent}.md` — 各エージェントの独立草案（末尾に「最強の主張」。極限まで逸脱）
- `reconciliation.md` — 昇華の下地（昇華推理。最終化が読む思考の土台）
- `elevated.md` — 昇華成果物（昇華推理 → 最終化の結果）
...
ところまで発散する。この草案が昇華段階で他の観点（収益・独自性）とどう衝突し、
止揚されるかは `reconciliation.md` → `elevated.md` に跡が残る。
